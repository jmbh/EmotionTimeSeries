...
permfunc <- function(iter, dat, nobs.per.person, group.per.person, outnames) {
  ...
  for (outname in outnames) {
   ...
   if (any(is.na(b.G1)) | any(is.na(b.G2))) {
      ...
      return((b.G2[2,1]+b.G2[6,1]) - (b.G1[2,1]+b.G1[6,1]))
...
b.diff.obs <- (b.G2[2,1]+b.G2[6,1]) - (b.G1[2,1]+b.G1[6,1])
...
capture.output(sav, file=paste0("tabletestdiffjoyandposttoint.txt"))
