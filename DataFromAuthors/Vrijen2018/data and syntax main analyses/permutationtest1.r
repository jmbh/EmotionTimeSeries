...
permfunc <- function(iter, dat, nobs.per.person, group.per.person, outnames) {
   ...
   if (any(is.na(b.G1)) | any(is.na(b.G2))) {
      ...
      return((abs(b.G2[2,1])+abs(b.G2[2,2])+abs(b.G2[2,3])+abs(b.G2[2,4])+abs(b.G2[2,5])+abs(b.G2[2,6])+abs(b.G2[2,7])+abs(b.G2[6,1])+abs(b.G2[6,2])+abs(b.G2[6,3])+abs(b.G2[6,4])+abs(b.G2[6,5])+abs(b.G2[6,6])+abs(b.G2[6,7])) - (abs(b.G1[2,1])+abs(b.G1[2,2])+abs(b.G1[2,3])+abs(b.G1[2,4])+abs(b.G1[2,5])+abs(b.G1[2,6])+abs(b.G1[2,7])+abs(b.G1[6,1])+abs(b.G1[6,2])+abs(b.G1[6,3])+abs(b.G1[6,4])+abs(b.G1[6,5])+abs(b.G1[6,6])+abs(b.G1[6,7])))
...
b.diff.obs <- (abs(b.G2[2,1])+abs(b.G2[2,2])+abs(b.G2[2,3])+abs(b.G2[2,4])+abs(b.G2[2,5])+abs(b.G2[2,6])+abs(b.G2[2,7])+abs(b.G2[6,1])+abs(b.G2[6,2])+abs(b.G2[6,3])+abs(b.G2[6,4])+abs(b.G2[6,5])+abs(b.G2[6,6])+abs(b.G2[6,7])) - (abs(b.G1[2,1])+abs(b.G1[2,2])+abs(b.G1[2,3])+abs(b.G1[2,4])+abs(b.G1[2,5])+abs(b.G1[2,6])+abs(b.G1[2,7])+abs(b.G1[6,1])+abs(b.G1[6,2])+abs(b.G1[6,3])+abs(b.G1[6,4])+abs(b.G1[6,5])+abs(b.G1[6,6])+abs(b.G1[6,7]))
...
capture.output(sav, file=paste0("tabletestdiffjoyandposttoall.txt"))
