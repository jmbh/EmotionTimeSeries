...
permfunc <- function(iter, dat, nobs.per.person, group.per.person, outnames) {
  ...
  for (outname in outnames) {
   ...
   if (any(is.na(b.G1)) | any(is.na(b.G2))) {
      ...
      return((abs(b.G2[3,1])+abs(b.G2[3,2])+abs(b.G2[3,3])+abs(b.G2[3,4])+abs(b.G2[3,5])+abs(b.G2[3,6])+abs(b.G2[3,7])+abs(b.G2[4,1])+abs(b.G2[4,2])+abs(b.G2[4,3])+abs(b.G2[4,4])+abs(b.G2[4,5])+abs(b.G2[4,6])+abs(b.G2[4,7])+abs(b.G2[5,1])+abs(b.G2[5,2])+abs(b.G2[5,3])+abs(b.G2[5,4])+abs(b.G2[5,5])+abs(b.G2[5,6])+abs(b.G2[5,7])+abs(b.G2[7,1])+abs(b.G2[7,2])+abs(b.G2[7,3])+abs(b.G2[7,4])+abs(b.G2[7,5])+abs(b.G2[7,6])+abs(b.G2[7,7])) - (abs(b.G1[3,1])+abs(b.G1[3,2])+abs(b.G1[3,3])+abs(b.G1[3,4])+abs(b.G1[3,5])+abs(b.G1[3,6])+abs(b.G1[3,7])+abs(b.G1[4,1])+abs(b.G1[4,2])+abs(b.G1[4,3])+abs(b.G1[4,4])+abs(b.G1[4,5])+abs(b.G1[4,6])+abs(b.G1[4,7])+abs(b.G1[5,1])+abs(b.G1[5,2])+abs(b.G1[5,3])+abs(b.G1[5,4])+abs(b.G1[5,5])+abs(b.G1[5,6])+abs(b.G1[5,7])+abs(b.G1[7,1])+abs(b.G1[7,2])+abs(b.G1[7,3])+abs(b.G1[7,4])+abs(b.G1[7,5])+abs(b.G1[7,6])+abs(b.G1[7,7])))
...
b.diff.obs <- (abs(b.G2[3,1])+abs(b.G2[3,2])+abs(b.G2[3,3])+abs(b.G2[3,4])+abs(b.G2[3,5])+abs(b.G2[3,6])+abs(b.G2[3,7])+abs(b.G2[4,1])+abs(b.G2[4,2])+abs(b.G2[4,3])+abs(b.G2[4,4])+abs(b.G2[4,5])+abs(b.G2[4,6])+abs(b.G2[4,7])+abs(b.G2[5,1])+abs(b.G2[5,2])+abs(b.G2[5,3])+abs(b.G2[5,4])+abs(b.G2[5,5])+abs(b.G2[5,6])+abs(b.G2[5,7])+abs(b.G2[7,1])+abs(b.G2[7,2])+abs(b.G2[7,3])+abs(b.G2[7,4])+abs(b.G2[7,5])+abs(b.G2[7,6])+abs(b.G2[7,7])) - (abs(b.G1[3,1])+abs(b.G1[3,2])+abs(b.G1[3,3])+abs(b.G1[3,4])+abs(b.G1[3,5])+abs(b.G1[3,6])+abs(b.G1[3,7])+abs(b.G1[4,1])+abs(b.G1[4,2])+abs(b.G1[4,3])+abs(b.G1[4,4])+abs(b.G1[4,5])+abs(b.G1[4,6])+abs(b.G1[4,7])+abs(b.G1[5,1])+abs(b.G1[5,2])+abs(b.G1[5,3])+abs(b.G1[5,4])+abs(b.G1[5,5])+abs(b.G1[5,6])+abs(b.G1[5,7])+abs(b.G1[7,1])+abs(b.G1[7,2])+abs(b.G1[7,3])+abs(b.G1[7,4])+abs(b.G1[7,5])+abs(b.G1[7,6])+abs(b.G1[7,7]))
...
capture.output(sav, file=paste0("tabletestdiffnegtoallabs.txt"))
